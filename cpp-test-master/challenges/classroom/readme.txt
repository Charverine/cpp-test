...
complete your classroom presence list or 
to consult a specific
...
of queries, 
followed by N queries Q, each followed by the amount of
...
1 
- Insert student in the presence list
    
2 
- Consult student in the presence list in the given position
...
queries. 
In the second line we tell we want to insert a student in the 
presence list, two times. 
In the fifth line we tell the program we
